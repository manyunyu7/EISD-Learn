...
class AddAccesFlagToCourseSectionView extends Migration
{
    public function up()
    {
        ...
        AS SELECT a.id as `lesson_id`,a.course_title as lessons_title, a.mentor_id ,
         ...
         c.section_order, c.section_title, c.section_content ,
          c.section_video, c.created_at,c.updated_at, c.can_be_accessed
    ...
    public function down()
    {
        ...
        // Note: The `can_be_accessed` column is effectively removed by recreating the view without including it.
    }
}
