                    ...
                    <div class='card card-small mb-3'>
                        ...
                        <div class='card-body container-fluid'>
                            ...
                            <div class="form-group">
                                <input required id="input-video" type="file" onchange="previewVideo()" class="form-control @error('video') is-invalid @enderror" name="video">
                    ...
                    <div class="card card-small mb-3">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input id="inputTitle" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" placeholder="Masukkan Nama Kelas">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category" id="">
                                    ...
                                    <option value="Human Resource and Development">Human Resource and Development</option>
                            ...
                            <div class="card border-0 shadow rounded">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control ckeditor @error('content') is-invalid @enderror" name="content" rows="5" placeholder="Masukkan Deskripsi Kelas">{{ old('content') }}</textarea>
