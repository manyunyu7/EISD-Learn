                ...
                <div class="container">
                    ...
                    <li class="nav-item card p-1 bg-light" style="margin-bottom: 6px !important">
                        ...
                        <div class="mt-1 mb-1">
                            ...
                            @elseif (isset($item->isLastSection) && $item->isLastSection)
                            <span class="badge badge-secondary text-small">Sedang Dipelajari</span>
                            @else
                            <span class="badge badge-secondary text-small">Belum Diambil</span>
                            @endif
                            @else
                            <span class="badge badge-secondary text-small">Data tidak tersedia</span>
                            @endif
                        </div>
                    </li>
                    @empty
