    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        departmentDropdown.addEventListener('change', function() {
            ...
            fetch('/find-student-by-department', {
                    ...
                    body: JSON.stringify({
                        name_of_department: departmentId
                    })
                })
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn " style="background-color: #208DBB">
                    ...
                    <table class="table">
                        ...
                        <tbody id="studentsTable">
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="avatar-sm">
                                        <img src="{{ Storage::url('public/profile/') . $student->profile_url }}" alt="..." class="avatar-img rounded-circle" onerror="this.onerror=null; this.src='{{ url('/default/default_profile.png') }}'; this.alt='Alternative Image';">
                                    </div>
                                </th>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('student.delete', ['id' => $student->id, 'lessonId' => $lessonId]) }}">
                                        ...
                                        <button onclick="return confirm('Are you sure?')" class="btn" style="background-color: #FC1E01;
                                                border-radius: 15px;
                                                width:45px;
                                                height: 40px;
                                                position: relative;
