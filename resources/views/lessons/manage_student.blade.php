                        ...
                        @elseif(session() -> has('error'))
                            ...
                            <div class="card-body">
                                <a href="{{ url('lesson/create') }}">
                                    <button class="btn btn-primary btn-border btn-round mb-3">Buat Kelas Baru</button>
                                </a>
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($studentData as $student)
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($student['section_taken'] as $section)
                                                    <div class="card">
                                                        <div class="card-header" data-toggle="collapse"
                                                             href="#sectionTaken{{$student['student_id']}}">
                                                            Section ID: {{ $section['section_id'] }}
                                                        </div>
                                                        <div id="sectionTaken{{$student['student_id']}}"
                                                             class="collapse">
                                                            <div class="card-body">
                                            ...
                                            <td>
                                                @foreach ($student['section_remaining'] as $section)
                                                    <div class="card">
                                                        <div class="card-header" data-toggle="collapse"
                                                             href="#sectionRemaining{{$student['student_id']}}">
                                                            Section ID: {{ $section['id'] }}
                                                        </div>
                                                        <div id="sectionRemaining{{$student['student_id']}}"
                                                             class="collapse">
                                                            <div class="card-body">
                                                                {{ $section['section_title'] }}
                                                            </div>
