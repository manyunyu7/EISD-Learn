        ...
        <div class="main-content-container container-fluid px-4 mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-12">
                                <div class="tab-content" id="v-pills-with-icon-tabContent">
                                    {{-- FORM INPUT INFORMASI DASAR MATERI --}}
                                        <div class="tab-pane fade show active" id="v-pills-home-icons" role="tabpanel"
                                            ...
                                            {{-- END OF FIELD INPUT QUIZ VALIDATION --}}
                                            
                                            {{-- FIELD INPUT URUTAN MATERI --}}
                                                <div class="form-group">
                                            ...
                                            {{-- END OF FIELD INPUT URUTAN MATERI --}}
                                        </div>
                                    {{-- END OF FORM INPUT INFORMASI DASAR MATERI --}}

                                    {{-- FORM INPUT FILE UTAMA MATERI --}}
                                    ...
                                    {{-- END OF FILE UTAMA MATERI --}}
                                    
                                    {{-- FORM INPUT KONTEN MATERI --}}
                                    ...
                                    {{-- END OF FORM INPUT KONTEN MATERI --}}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid col-12">
                ...
                @elseif(session() -> has('error'))
                    ...
                    {{-- START OF CONTAINER MANAGE MATERI KELAS --}}
                            ...
                            <div class="table-responsive">
                                <table id="basic-datatables" class="table table-bordered w-100 @if (count($dayta) < 1)   d-none @endif">
                                    ...
                                    @forelse ($dayta as $data)
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                ...
                                                                <div class="box-body">
                                                                    ...
                                                                    <div class="form-group" id="examCheck">
                                                                        <label>Pilih Exam yang akan dimuat</label>
                                                                        <select class="form-control" name="quiz_session_id" id="isExam_update">
                                                                            <option value="{{ $data->quiz_session_id }}" {{ $data->quiz_session_id == '-' ? 'selected' : '' }}>-</option>
                                                                            @foreach($examSessions as $examSession)
                                                                    ...
                                                                    <div class="form-group" id="duration_u_Take" style="display: {{ $data->duration_take == '-' ? 'none' : 'block' }};">
                                                                        <label>Durasi Pengerjaan</label>
                                                                        <select class="form-control" name="durationTake" id="duration_u_Take">
                                        ...
                                        <tr>
                                            <div class="modal fade modal-dialog modal-xl bd-example-modal-xl" id="video-modal{{$loop->iteration}}">
                    ...
                    {{-- END OF CONTAINER MANAGE MATERI KELAS --}}
