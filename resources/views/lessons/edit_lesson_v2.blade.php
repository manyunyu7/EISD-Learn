    ...
    <div class="page-inner">
        ...
        <div class="container-fluid">
            <div class="load-soal" style="background-color: none">
                <form id="addSessionForm" action="{{ url('/update-lesson/' . $lesson_id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <input type="radio" id="general" name="tipe" value="General"
                                        {{ $myClass->tipe == 'General' ? 'checked' : '' }} style="margin-right: 10px;"
                                        onclick="showGeneralInfo()">
                                    <label for="general" class="mr-3">General</label>

                                    <input type="radio" id="specific" name="tipe" value="Specific"
                                        {{ $myClass->tipe == 'Specific' ? 'checked' : '' }} style="margin-right: 10px;"
                                        onclick="hideGeneralInfo()">
                                    <label for="specific">Specific</label>
                                </div>
                                <small id="generalInfo"
                                    style="color: red; {{ $myClass->tipe == 'General' ? 'display: inline;' : 'display: none;' }}">Tipe
                                    General dapat diakses oleh semua department</small>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <select id="department_id" {{ $myClass->tipe == 'Specific' ? '' : 'disabled' }}
                                        name="department_id[]" class="form-control form-select-lg js-example-basic-multiple"
                                        multiple>
                                        <!-- Your options here -->
                                    </select>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <div class="card" style="width: 100%; max-width: 1080px;">
                                            <img id="imgPreview" style="aspect-ratio: 16 / 9"
                                        ...
                                        <div class="input-group mb-3">
                                            <input hidden name="existing_file_name"
                                                value="{{ $myClass->course_cover_image }}" type="text">
