        ...
        <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters mb-4">
                <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                    <span class="text-uppercase page-subtitle">Tambah Quiz Baru</span>
                    <h3 class="page-title">Exam/Quiz Baru</h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <form action="{{ url('/exam/store') }}" method="POST" enctype="multipart/form-data">
                        <!-- Add New Post Form -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input id="inputTitle" type="text"
                                           ...
                                           value="{{ old('title') }}" placeholder="Masukkan Judul Exam/Quiz">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Deskripsi Exam">{{ old('content') }}</textarea>
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="card card-post card-round">
                        <img class="card-img-top" id="imgPreview"
                             src="http://feylabs.my.id/fm/mdln_asset/mdln_4_side_placeholder.png" alt="Card image cap">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="avatar">
            ...
            <div class="row d-none">
                <div class="col-12">
                    <div class='card card-small mb-3'>
                        <div class="card-header border-bottom">
                            <label class="font-weight-bold">Soal</label>
                        </div>
                        <div class='card-body'>
                            <div class="container">
                                ...
                                <form id="examForm" method="POST">
                                    ...
                                    <!-- Add question button -->
                                    <button class="btn btn-md btn-primary" type="button" id="addQuestionBtn">+ Add
                                        Question
                                    </button>
