            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="page-header row no-gutters mb-4">
                    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                        <span class="text-uppercase page-subtitle">Edit Karya</span>
                        <h3 class="page-title">Edit Portfolio/Karya</h3>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input id="inputTitle" type="text"
                                        ...
                                        value="{{$data->title, old('title'), }}" placeholder="Masukkan Nama Project/Karya">
                                ...
                                <div class="card border-0 shadow rounded">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" value="{{$data->link,old('link')}}"
                                            class="form-control" name="link" id="" aria-describedby="helpId" placeholder="Masukkan Link Proyek Disini">
                                          <small id="helpId" class="form-text text-muted  @error('link') is-invalid @enderror">Link Proyek ( Github/Dribble/Academia.edu/etc)</small>
                                      ...
                                      @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control ckeditor @error('content') is-invalid @enderror"
                                                name="content" rows="5"
                                                placeholder="Masukkan Konten Blog">{{ $data->content,old('content') }}</textarea>
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="card card-post card-round">
                            <img class="card-img-top" id="imgPreview"
                                 src="{{ Storage::url('public/portfolio/'). $data->image }}" alt="Card image cap">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="avatar">
