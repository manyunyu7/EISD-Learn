...
@section('body')
    ...
    <div class="container-fluid ">
        <h1 style="text-align: center" class="mt-5">Tulisan Para Mentor dan Siswa</h1>
        <hr class="worm">
                ...
                <div class="col-lg-4 col-sm-6 my-2">
                    <div class="album-poster-parent" style="background-color: white !important">
                        <a href="javascript:void();" class="album-poster" data-switch="0">
                            <img class="fufufu" onerror="this.onerror=null; this.src='./assets/album/n5'" src="{{  Storage::url('public/blogs/') . $data->image }}" alt="La Noyee">
                        </a>
                        <br>
                        ...
                        <div class="d-flex">
                            <div class="avatar">
                                <img src="{{ Storage::url('public/profile/') . $data->writer_profile }}" alt="..." class="avatar-img rounded-circle">
                            </div>
                            <div class="info-post ml-2">
                                <p class="username">{{ $data->writer_name }}</p>
                                <a href="{{ route('blog.read',$data->id) }}">
                                    <button type="button" class="btn btn-outline-dark">Baca Blog</button>
                                </a>
                            </div>
                        </div>
