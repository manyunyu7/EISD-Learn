@php
	$countRegisteredClass=$classRegisteredCount;
	$countProject = $projectCreatedCount;
	$countStudent = $studentCount;
	$countBlog = $blogCreatedCount;
@endphp
...
Circles.create({
			id:'circles-1',
			radius:45,
			value: {{$countRegisteredClass}},
			maxValue:100,
			width:7,
			text: {{$countRegisteredClass}},
