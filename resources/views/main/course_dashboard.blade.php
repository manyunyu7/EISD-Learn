                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-1 ms-auto mt-4">
                                    <a href="#" id="seeAllLink" style="text-decoration: none; color:#8C94A3">See
                                        All</a>
                                </div>
                                <script>
                                ...
                                <div class="card">
                                    <div class="card-header" style="padding: 10px;">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <img style="width: 12%; height: auto; margin-right: 10px;"
                                                src="{{ url('/icons/rank_1.svg') }}" alt="User Icon">
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <div id="scoring" class="d-flex align-items-center">
                                                ...
                                                <img style="width: 35%; height: auto; margin-right: 10px;"
                                                    src="{{ url('/icons/tropy.svg') }}" alt="User Icon">
                                                <a href="#" style="text-decoration: none; color: black;">
                                                    <p style="font-size: 18px; margin: 0; white-space: nowrap;">
                                                        <b>{{ $rank1->current_score }}</b>
                                                    </p>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-header" style="padding: 10px;">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <img style="width: 12%; height: auto; margin-right: 10px;"
                                                src="{{ url('/icons/rank_2.svg') }}" alt="User Icon">
                                            <a href="#" style="text-decoration: none; color: black;">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-header" style="padding: 10px;">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <img style="width: 12%; height: auto; margin-right: 10px;"
                                                src="{{ url('/icons/rank_3.svg') }}" alt="User Icon">
                                            <a href="#" style="text-decoration: none; color: black;">
                    ...
                    @else
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <h3>
                                        Minimal ada 3 Student yang telah mengerjakan Post Test untuk ditampilkan dalam
                                        Leaderboard
                                    </h3>
                                </div>
                            </div>
