        ...
        <div class="row page-inner col-md-12">
            ...
            <div class="col-sm-3 col-md-5 col-lg-2" >
                ...
                <div class="btn-group">
                    ...
                    <button type="button" class="btn btnSort-custom dropdown-toggle dropdown-toggle-split" id="categoryDropdownToggle" data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent">
                        <span class="visually-hidden"></span>
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="categoryDropdownToggle" style="width: 100%;" id="categoryDropdown">
                        ...
                        <li><a class="dropdown-item text-left" href="#" onclick="changeCategoryText('General')">General</a></li>
                    </ul>
                </div>
