        ...
        <div class=" row">
            <div class="col-md-6 d-flex justify-content-center center" data-aos="zoom-in-up">
                <div class="ml-3">
                    ...
                    <div>
                        <p>{{ config('app.name') }} menggunakan tools yang sering digunakan oleh perusahaan dan kampus</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="container-fluid row">
                ...
                <div class="card-body">
                    <div class="text-center">
                        <img class="mb-4 text-center" width="150px" height="150px"
                            src="{{ URL::to('/') }}/home_assets/img/lecturer1.png" alt="">
                    </div>
            ...
            <div class="col-md-12 col-lg-4 col-12 card " >
                <div class="card-body">
                    <div class="text-center">
                        <img class="mb-4 text-center" width="150px" height="150px"
                            src="{{ URL::to('/') }}/home_assets/img/student_henry.png" alt="">
                    </div>
                    ...
                    <p class="card-text text-center"><a
                            href="https://github.com/henryaugusta">https://github.com/henryaugusta</a>
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-4 col-12 card " >
                <div class="card-body">
                    <div class="text-center">
                        <img class="mb-4 text-center" width="150px" height="150px"
                            src="{{ URL::to('/') }}/home_assets/img/firriezky.png" alt="">
                    </div>
                    ...
                    <p class="card-text text-center"><a
                            href="https://github.com/firriezky">https://github.com/firriezky</a>
                    </p>
                </div>
            </div>
        </div>
