...
@section('main')
    ...
    <form action="{{ route('lesson_category.edit',$data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="page-header row no-gutters mb-4">
                    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                        ...
                        <h3 class="page-title">Edit Kategori {{$data->name}}</h3>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input id="inputTitle" type="text"
                                           ...
                                           value="{{ old('title',$data->name) }}" placeholder="Masukkan Nama Kategori">
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="card card-post card-round">
                            <img class="card-img-top" id="imgPreview"
                                 src="{{ Storage::url('public/class/category/').$data->img_path }}" alt="Card image cap">
                            <div class="card-body">
